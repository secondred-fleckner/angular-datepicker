...
(function withAngular(angular, navigator, window) {
    ...
    var module = angular.module('720kb.datepicker', []),
        ...
        return [
            '<div class="_720kb-datepicker-calendar-header">Project Start: {{ monthCountStart | date: \'dd.MM.y\' }}',
    ...
    module.directive('datepicker', [
        '$window', '$compile', '$locale', '$filter', '$interpolate',
            ...
            return {
                ...
                'link': function link($scope, element, attr) {
                    ...
                    var unregisterDataSetWatcher = $scope.$watch('ngModel', function dateSetWatcher(newValue, oldValue) {
                        ...
                        } else if (angular.toString(newValue) && !isNaN(Date.parse(newValue))) {
                        ...
                        if (typeof oldValue === typeof date && date.getTime() === oldValue.getTime()) {
                            return;
                        }
